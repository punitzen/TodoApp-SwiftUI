...
extension LocalNotificationManager {
    func schedule(data: LocationNotificationData, _ completion: @escaping (_ success: Bool) -> Void) {
        ...
        add(content: content, in: data.medaData, at: data.reminderDate) { request, error in
